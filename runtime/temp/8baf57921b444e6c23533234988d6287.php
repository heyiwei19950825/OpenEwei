<?php /*a:1:{s:67:"E:\RaningWork\OpenCenter\application\admin\view\resthome\index.html";i:1543911128;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                ...
                <script type="text/html" id="barDemo">
                    <a class="layui-btn layui-btn-xs" lay-event="other" data-title="审核" data-url="<?php echo url('audit'); ?>" data-width="50%" data-height="90%">审核</a>
